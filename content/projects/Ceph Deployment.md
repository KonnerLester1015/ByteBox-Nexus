...
{{< callout type="warning" >}}
  ***Note**:* 
If you have a lot of pools and users to make you can utilze a bash script that will create the pool, set the quota, and create the users with the correct permissions. Refer to [Bulk Create RBD Pools and Users](https://konnerlester1015.github.io/ByteBox-Nexus/docs/ceph/bulk-create-rbd-pools-and-users/)
{{< /callout >}}
